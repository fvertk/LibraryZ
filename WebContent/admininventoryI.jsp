...
if (session.getAttribute("u_uname").equals("admin"))
{
	...
	session.setAttribute("copies", copies);
	...
	updateQ = "UPDATE books SET quantity = (quantity+" + copies + ") WHERE name='" + (String)session.getAttribute("title") + "'";
	...
	%>
	<br><br>
	You increased the count of "<%=title %>" by <%=copies %> copies.
	<br><br>
