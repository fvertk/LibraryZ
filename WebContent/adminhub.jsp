...
if((String)session.getAttribute("u_uname") != null)
{
	...
	{	
		...
		Admin logged in.
		<br><br>
		<a href="adminadd.jsp">Add New Book</a>
		<br>
		<a href="admininventory.jsp">Change Book Inventory</a>
		<br>
		<a href="adminstats.jsp">Statistics</a>
		<br>
		<form method="post" action = "adminuserawards.jsp">
		Admin User Awards (put in m)
